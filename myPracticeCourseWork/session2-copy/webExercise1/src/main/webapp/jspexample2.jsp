<%-- 
    ...
    Created on : 6 Oct 2021, 11:37:28
    Author     : hannah-ann
--%>
...
// here we are looking for the userName value in the web request which called this page
    ...
    String address = request.getParameter("addressHome");
...
<html>
    ...
    <body>
        ...
        <form action="./jspexample2.jsp" method="get">
            ...
            <p>address <input type="text" name="addressHome" value=""></p>
        ...
        <form action="./jspexample2.jsp" method="post">
            ...
            <p>user name <input type="text" name="userName" value="<%=name%>"></p><!-- comment -->
            <p>POSTCODE <input type="text" name="addressHome" value="<%=address %>"></p>
